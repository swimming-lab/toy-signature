...
public class AgreementModel {
    ...
    @Value
    public static class AgreementModelNested {
        Long lessorId;
        String lessorName;
        String lessorAddr;
        String lessorTelNo;
        ...
        public static AgreementModelNested from(Agreement agreement) {
            ...
            return new AgreementModelNested(
                    ...
                    ProfileModelNested.from(agreement.getAuthor().getProfile()));
        }
    }
}
